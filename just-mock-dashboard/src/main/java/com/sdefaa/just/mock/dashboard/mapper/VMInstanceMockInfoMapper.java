...
public interface VMInstanceMockInfoMapper {
  ...
  @Insert("<script>" +
    "insert into vm_instance_mock_info(pid,class_name,method_name,method_args_desc,method_return_desc,api_url,api_type,api_method) values" +
    "<foreach collection='vmInstanceMockInfoModelList' item='vmInstanceMockInfoModel' separator=','>" +
    "(#{vmInstanceMockInfoModel.pid},#{vmInstanceMockInfoModel.className},#{vmInstanceMockInfoModel.methodName},#{vmInstanceMockInfoModel.methodArgsDesc},#{vmInstanceMockInfoModel.methodReturnDesc},#{vmInstanceMockInfoModel.apiUrl},#{vmInstanceMockInfoModel.apiType},#{vmInstanceMockInfoModel.apiMethod})" +
    "</foreach>" +
    "</script>")
