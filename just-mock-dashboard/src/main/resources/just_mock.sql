...
CREATE TABLE `vm_instance_mock_info` (
  ...
  `method_args_desc` varchar(5000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '方法参数描述',
  `method_return_desc` varchar(5000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '方法返回值类型描述',
  `api_method` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'API 方法',
