...
-- ----------------------------
INSERT INTO `mock_template_info`
VALUES (3, '{\n     \"age\":\"${p0.name}\",\n     \"name\":\"${name!}\"\n}', NULL, 'Julius is genius;all',
        '[{\"name\":\"name\",\"sequence\":\"tom,julius,jack,kitty\"}]',
...
INSERT INTO `mock_template_info`
VALUES (6, '{\n     \"age\":\"${p0.name}\",\n     \"name\":\"${name!}\"\n}', NULL, 'GET;query',
        '[{\"name\":\"name\",\"sequence\":\"000000,999999\"}]',
        '[\"{\\n  \\\"type\\\": \\\"HTTP_TASK\\\",\\n  \\\"content\\\": {\\n    \\\"url\\\": \\\"http://127.0.0.1:9090/hello2\\\",\\n    \\\"payloadType\\\": \\\"application/json\\\",\\n    \\\"payload\\\": \\\"age=${p0.name}&name=${name}\\\",\\n    \\\"method\\\": \\\"GET\\\"\\n  }\\n}\"]',
        '2023-04-01 04:37:09', '2023-04-01 19:55:35');
INSERT INTO `mock_template_info`
VALUES (7, '{\n     \"age\":\"${p0.name}\",\n     \"name\":\"${name!}\"\n}', NULL, 'POST;form-data',
        '[{\"name\":\"name\",\"sequence\":\"julius,sdefaa\"}]',
        '[\"{\\n  \\\"type\\\": \\\"HTTP_TASK\\\",\\n  \\\"content\\\": {\\n    \\\"url\\\": \\\"http://localhost:9090/hello3\\\",\\n    \\\"payloadType\\\": \\\"application/x-www-form-urlencoded\\\",\\n    \\\"payload\\\": \\\"age=${p0.name}&name=${name}\\\",\\n    \\\"method\\\": \\\"POST\\\"\\n  }\\n}\"]',
        '2023-04-01 19:14:22', '2023-04-01 19:23:22');
INSERT INTO `mock_template_info`
VALUES (8, '{\n     \"age\":\"${p0.name}\",\n     \"name\":\"${name!}\"\n}', NULL, 'POST;json',
        '[{\"name\":\"name\",\"sequence\":\"julius,hello\"}]',
        '[\"{\\n  \\\"type\\\": \\\"HTTP_TASK\\\",\\n  \\\"content\\\": {\\n    \\\"url\\\": \\\"http://127.0.0.1:9090/hello1\\\",\\n    \\\"payloadType\\\": \\\"application/json\\\",\\n    \\\"payload\\\": \\\"{\\\\\\\"age\\\\\\\":\\\\\\\"${p0.name}\\\\\\\",\\\\\\\"name\\\\\\\":\\\\\\\"${name!}\\\\\\\"}\\\",\\n    \\\"method\\\": \\\"POST\\\"\\n  }\\n}\"]',
