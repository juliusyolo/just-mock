...
public class ControllerClassInformationCollectorImpl extends AbstractClassInformationCollector {
  ...
  private final static String TARGET_CONTROLLER_ANNOTATION_CLASS = "org.springframework.stereotype.Controller";

  @Override
  public boolean match(Class<?> clazz) {
    return !clazz.isInterface()
      && (CollectorUtils.isClassAnyAnnotated(TARGET_CONTROLLER_ANNOTATION_CLASS, clazz)
      || CollectorUtils.isClassAnyAnnotated(TARGET_CONTROLLER_ANNOTATION_CLASS, clazz.getSuperclass())
      || CollectorUtils.isClassAnyAnnotated(TARGET_CONTROLLER_ANNOTATION_CLASS, clazz.getInterfaces()));
  }
  ...
  public TargetClass collect(Class<?> clazz) {
    ...
    if (CollectorUtils.isClassAnyAnnotated(TARGET_CONTROLLER_ANNOTATION_CLASS, clazz)) {
      targetClass.setAnnotations(CollectorUtils.generateAnnotationList(clazz));
    } else if (CollectorUtils.isClassAnyAnnotated(TARGET_CONTROLLER_ANNOTATION_CLASS, clazz.getSuperclass())) {
